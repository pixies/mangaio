...
from mangaio.accounts.views import (
    add_account,
    login_account,
    edit_account,
    del_account,
...
urlpatterns = [
    ...
    url(r'^solicitar-senha/(?P<uidb64>[0-9A-Za-z_\-]+)/(?P<token>.+)/$', 'django.contrib.auth.views.password_reset_confirm', name='confirme-nova-senha'),
